...
#include <stdafx.h>
#include "resource.h"
#include "..\ClassicStartSetup\UpdateBin\resource.h"
...
//#define UPDATE_LOG L"-|%LOCALAPPDATA%\\ClassicStart\\UpdateLog.txt"
...
{
	const wchar_t *compName=L"Classic Start";
	switch (component)
	{
		...
		case COMPONENT_UPDATE: compName=L"Classic Start Update"; break;
	}
...
static DWORD WINAPI ThreadVersionCheck( void *param )
{
	...
	// download file
	wchar_t fname[_MAX_PATH]=L"%ALLUSERSPROFILE%\\ClassicStart";
...
{
	// download file
	wchar_t path[_MAX_PATH]=L"%ALLUSERSPROFILE%\\ClassicStart\\Languages";
