...
static void GetRegPaths( TSettingsComponent component, const wchar_t *&regPath, const wchar_t *&gpPath )
{
	switch (component)
	{
		case COMPONENT_EXPLORER:
			regPath=L"Software\\IvoSoft\\ClassicExplorer";
			gpPath=L"Software\\Policies\\IvoSoft\\ClassicExplorer";
			break;
		case COMPONENT_MENU:
			regPath=L"Software\\IvoSoft\\ClassicStartMenu";
			gpPath=L"Software\\Policies\\IvoSoft\\ClassicStartMenu";
			break;
		case COMPONENT_IE:
			regPath=L"Software\\IvoSoft\\ClassicIE";
			gpPath=L"Software\\Policies\\IvoSoft\\ClassicIE";
			break;
		...
		case COMPONENT_SHARED:
			regPath=L"Software\\IvoSoft\\ClassicStart";
			gpPath=L"Software\\Policies\\IvoSoft\\ClassicStart";
			break;
	}
}
...
/*
	...
	if (SUCCEEDED(SHGetPropertyStoreForWindow(m_hWnd,IID_IPropertyStore,(void**)&pStore)))
	{
		PROPVARIANT val;
		val.vt=VT_LPWSTR;
		val.pwszVal=L"ClassicStart.Settings.Dialog";
...
bool HasHelp( void )
{
	...
	*PathFindFileName(path)=0;
	...
	Sprintf(topic,_countof(topic),L"%s%sClassicStart.chm",path,GetDocRelativePath());
...
void ShowHelp( void )
{
	...
	*PathFindFileName(path)=0;
	wchar_t topic[_MAX_PATH];
	Sprintf(topic,_countof(topic),L"%s%sClassicStart.chm::/%s.html",path,GetDocRelativePath(),PathFindFileName(g_SettingsManager.GetRegPath()));
...
"\t</supportedOn>\r\n"
"\t<categories>\r\n"
"\t\t<category name=\"ClassicStartMenu\" displayName=\"$(string.ClassicStartMenuCat)\" explainText=\"$(string.ClassicStartMenuCatHelp)\">\r\n"
"\t\t\t<parentCategory ref=\"classic_shell:ClassicStart\" />\r\n"
"\t\t</category>\r\n";
...
"\t\t\t<string id=\"ClassicStartCat\">%ClassicStartCat%</string>\r\n"
"\t\t\t<string id=\"ClassicStartCatHelp\">%ClassicStartCatHelp%</string>\r\n"
"\t\t\t<string id=\"SUPPORTED_CS404\">%SUPPORTED_CS404%</string>\r\n";

static const char *g_AdmlText1csm=
"\t\t\t<string id=\"ClassicStartMenuCat\">%ClassicStartMenuCat%</string>\r\n"
"\t\t\t<string id=\"ClassicStartMenuCatHelp\">%ClassicStartMenuCatHelp%</string>\r\n"
...
bool SaveAdmx( TSettingsComponent component, const char *admxFile, const char *admlFile, const char *docFile )
{
	...
	{
		case COMPONENT_EXPLORER:
			keyName="Software\\Policies\\IvoSoft\\ClassicExplorer";
			prefix="CE_";
			...
			break;
		case COMPONENT_MENU:
			keyName="Software\\Policies\\IvoSoft\\ClassicStartMenu";
			prefix="CSM_";
			...
			break;
		case COMPONENT_IE:
			keyName="Software\\Policies\\IvoSoft\\ClassicIE";
			prefix="CIE_";
			catName="ClassicIE";
			...
			break;
		case COMPONENT_SHARED:
			keyName="Software\\Policies\\IvoSoft\\ClassicStart";
			prefix="CS_";
